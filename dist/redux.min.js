...
var Store = exports.Store = function () {
    ...
    function Store(initialData, options) {
        ...
        var _options = options,
            _options$actionKey = _options.actionKey,
        ...
        this.subscribe = function (cb) {
            if (typeof cb != 'function') throw new Error('the #subscribe function expected a function');
        ...
        this.dispatch = function (actions) {
            if (Array.isArray(actions) || (typeof actions === 'undefined' ? 'undefined' : _typeof(actions)) === 'object') reduce(actions);else throw new Error('dispatch is expecting an array of actions or an action object');
        };
        ...
        function _reduce(actions, done) {
            ...
            actions.forEach(function (action) {
                ...
                if ((typeof action === 'undefined' ? 'undefined' : _typeof(action)) != 'object') throw new Error('dispatch needs an Action Object or an array of Action Objects');
                ...
                var before = onBefore[event] || [];

                // animation callback that runs after calculations
                var after = onAfter[event] || [];
        ...
        function startup() {
            var cache = !!sessionStorage && sessionStorage.getItem(CACHE_KEY);
            var data = null;
    ...
    Store.registerReducer = function (propertyPath, eventName, reducer) {
        ...
        if (!propertyPath || !eventName || typeof reducer != 'function') throw new Error('Parameters expect a string, string, function');
    ...
    function callbackHelper(collection) {
        ...
        return function (event, cb) {
            if (typeof event != "string" || typeof cb != 'function') throw new Error('Expecting string, function');
     ...
     * @return {Array}
     */
    Store.getRegisteredReducers = function () {
     ...
     * @return {boolean}
     */
    Store.prototype.isCachingEnabled = function () {
     ...
     * @return {boolean}
     */
    Store.willLoadFromCache = function () {
